...
double VehicleBase::tractor_length = 5.6;
double VehicleBase::tractor_width = 2.3;
double VehicleBase::tail_length = 10;
double VehicleBase::tail_width = 2.5;
double VehicleBase::safe_length = 7;
